(function (factory) {
  ...
  */
  ...
  _getBounds = function _getBounds(element, withoutTransforms) {
    ...
    return !_refreshing && !_ignoreResize && !_doc$2.fullscreenElement && _resizeDelay.restart(true);
  },
  ...
  var ScrollTrigger = /*#__PURE__*/function () {
    ...
    _proto.init = function init(vars, animation) {
      ...
      if (snap) {
        ...
        snapFunc = _isFunction$1(snap.snapTo) ? snap.snapTo : snap.snapTo === "labels" ? _getClosestLabel(animation) : snap.snapTo === "labelsDirectional" ? _getLabelAtDirection(animation) : gsap$1.utils.snap(snap.snapTo);
      ...
      if (!_coreInitted$1) {
        ...
        if (gsap$1) {
          ...
          if (_body) {
            ...
            _addListener(_win$2, "wheel", _onScroll);
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const decorLine = document.querySelector(".menu-decor"),
          ...
          popups = document.querySelectorAll(".popup"); // Loader
        ...
        "(min-width: 768px) and (min-height: 700px)": function () {
          ...
          $("#pagepiling").pagepiling({
            ...
            navigation: {
              ...
              bulletsColor: "#000",
              position: "right",
              tooltips: ["section1", "section2", "section3", "section4", "section5", "section6", "section7", "section8"]
            },
    ...
    if ($(".slick").length) {
      $(".slick").slick({
        ...
        prevArrow: '<button id="prev" type="button" class="btn btn-prev"><span class="icon-arrow-more" aria-hidden="true"></span></button>',
