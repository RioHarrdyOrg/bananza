(function (factory) {
  typeof define === 'function' && define.amd ? define('indexCopy', factory) :
  factory();
}((function () { 'use strict';
  ...
  */
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const decorLine = document.querySelector(".menu-decor"),
          offsetDecorLine = decorLine.offsetWidth / 2; // Pagepiling
    ...
    $("#pagepiling").pagepiling({
      ...
      onLeave: function (index, nextIndex, direction) {
        ...
        changeLine(".menu li:nth-child(" + nextIndex + ")"); // 1 => 7
    ...
    function showCont(id) {
      ...
      portfolioPhotos.forEach(el => {
        ...
        if (contId === id) {
          ...
          el.classList.remove("active"); // console.log("da");
        }
      });
    }
